          ...
          <table className="w-full text-left border-collapse">
            ...
            <tfoot>
              <tr className="border-t-2 border-slate-200 dark:border-slate-700">
                <td colSpan="5" className="pt-4 text-right font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wide text-sm">Grand Total</td>
                <td colSpan="2" className="pt-4 text-right font-bold text-2xl text-primary dark:text-sky-400">
